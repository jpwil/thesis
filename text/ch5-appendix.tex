...
% model specification
\input{tables/ch5/isc_model_terms_with_pg.tex}

% model specification
\input{tables/ch5/isc_model_terms_without_pg.tex}
...
\begin{figure}[tb]
  \centering
  \begin{overpic}[width=\textwidth, trim={3.3cm 0cm 0.3cm 0.3cm}, clip]{figures/ch5/forestCalM2.pdf}
...
% model stability
\input{tables/ch5/isc_model_stability.tex}
