...
\begin{figure}[tb]
  ...
  \begin{overpic}[width=0.9\textwidth, trim={3.5cm 0cm 1cm 0.3cm}, clip]{figures/ch5/forestCIM2.pdf}
    \put(0,5.5){\tiny \fcolorbox{black}{white}{$\tau^2$ = 0.62; $I^2$ = 82.8\%; p < .0001}}
  \end{overpic}
...
\begin{figure}[tb]
  ...
  \begin{overpic}[width=0.9\textwidth, trim={3.4cm 0cm 0.3cm 0.3cm}, clip]{figures/ch5/forestCalM2.pdf}
    \put(27,13){\fcolorbox{black}{white}{\tiny $\tau^2$ = 0.14; $I^2$ = 55.8\%; p = .0015}}
    \put(68,13){\fcolorbox{black}{white}{\tiny $\tau^2$ = 0.006; $I^2$ = 1.32\%; p = .62}}
  \end{overpic}
