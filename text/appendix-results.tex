...
\begin{landscape}
    \begin{figure}[tb]
        ...
        \caption{Distribution of categorical predictors by study. Missing data described by study. MF: miltefosine; NP: not performed; SDA: single-dose liposomal amphotericin B}
        \label{fig:isc_cr_log_comb}
    \end{figure}
\end{landscape}
