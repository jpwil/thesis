...
\subsection{\label{app:results-cp-dist-cont}Continuous predictor distributions by study}
...
\subsection{\label{app:results-cp-dist-cat}Categorical predictor distributions by study}
...
\begin{landscape}
    \begin{figure}[tb]
        ...
        \caption{Distribution of categorical predictors by study. Missing data described where present (anaemia, parasite source). MF: miltefosine; NP: not performed; SDA: single-dose liposomal amphotericin B}
...
\subsection{\label{app:results-cp-ass-cont-cont}Pooled continuous-continuous predictor associations}
...
\begin{landscape}
    \begin{figure}[tb]
        \centering
        \includegraphics[width=1.35\textwidth]{figures/ch5/isc_cont_cont.pdf}
...
\subsection{\label{app:results-cp-ass-cont-cat}Pooled continuous-categorical predictor associations}
...
\begin{landscape}
    \begin{figure}[tb]
        \centering
        \includegraphics[width=1.35\textwidth]{figures/ch5/isc_cont_cat.pdf}
