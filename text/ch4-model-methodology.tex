\begin{savequote}[8cm]
    For IPD meta-analysis situations, it can also be expensive, time consuming, and \textit{generally painstaking} to obtain and clean the raw data from multiple studies.
    \qauthor{--- Richard Riley et al.\cite{riley2016}}
\end{savequote}
