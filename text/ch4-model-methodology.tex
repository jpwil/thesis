...
Unadjusted relationships between the pooled candidate predictors and the outcome (relapse) are presented in graphical form with 95\% confidence intervals. Since this stage of the analysis is exploratory and descriptive, p-values are not presented to avoid multiple hypothesis testing and inflation of type I error, with emphasis instead placed on the shape, magnitude, and uncertainty of observed associations\cite{altman1986}.
