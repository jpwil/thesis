...
\subsection{\label{sec:out-definition}Outcome definition}

In Section \ref{sec:relapse} of Chapter \ref{ch:2-background}, relapse was described as `the reappearance of VL signs and symptoms following an initial treatment response', and `typically confirmed by direct visualisation of the parasite on a tissue aspirate smear'. Despite what may appear a clear definition, on closer inspection, it can be appreciated that even subtle variations in study design and relapse definition can, perhaps unexpectedly, impact the proportion of patients achieving relapse as a study outcome.

In a recent systematic review, Dahal et al. explored heterogeneity in the design and reporting of all VL therapeutic efficacy trials published between 2000--2021\cite{dahal2024}. Based on these findings, and from exploring definitions of initial cure and relapse in the contributed studies, important sources of heterogeneity can be identified.
...
- denominator information (at risk)
- relapse is binary
- loss of follow up
- cross-referencing with study publications (where available)

\subsection{\label{sec:eligibility}Participant eligibility}
