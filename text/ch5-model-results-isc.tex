...
\begin{figure}[tb]
  ...
  \begin{overpic}[width=0.9\textwidth, trim={3.5cm 0cm 1cm 0.3cm}, clip]{figures/ch5/forestCIM1.pdf}
    \put(0,5.5){\fcolorbox{black}{white}{\tiny $\tau^2$ = 0.43; $I^2$ = 77.4\%; p < .0001}}
  \end{overpic}
...
\begin{figure}[tb]
  ...
  \begin{overpic}[width=0.9\textwidth, trim={3.4cm 0cm 0.3cm 0.3cm}, clip]{figures/ch5/forestCalM1.pdf}
    \put(29,13){\fcolorbox{black}{white}{\tiny $\tau^2$ = 0.094; $I^2$ = 46.1\%; p = .01}}
    \put(72,13){\fcolorbox{black}{white}{\tiny $\tau^2$ = 0; $I^2$ = 0\%; p = .74}}
  \end{overpic}
