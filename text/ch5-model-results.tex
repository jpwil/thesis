...
\begin{landscape}
    \begin{figure}[tb]
        ...
        \caption{Distributions and predictor--outcomes relationships for categorical candidate predictors. Excluding missing data. 95\% binomial confidence intervals calculated using Wilson method. MF: miltefosine; Norm: normal; SDA: single-dose liposomal amphotericin B.}
