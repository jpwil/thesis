...
VL diagnosis has traditionally relied on visualisation of parasites from tissue aspirate smears (spleen, bone marrow, lymph node) or culture.

More recently, serological tests detecting anti-\textit{Leishmania} antibodies have become widely used, particularly the rK39 rapid diagnostic test (RDT) which has revolutionised VL diagnosis in the ISC\cite{chappuis2006}. Molecular diagnostics using polymerase chain reaction (PCR) techniques are increasingly being used in research and reference laboratories, although their role in routine clinical practice remains limited due to cost and infrastructure requirements\cite{burza2018}.

The gold standard diagnostic test for VL is direct observation of amastigotes on microscropy of tissue and smears
