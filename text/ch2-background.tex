...
\begin{landscape}
  ...
  \begin{figure}[tb]
    ...
    \caption{Geographical distribution of VL reported per country. `Considered endemic': at least one autochthonous case has been reported, with or without the entire cycle of transmission being demonstrated. Data source: World Health Organization Global Health Observatory, accessed 18 January 2026\cite{who_gho}.}
    \label{fig:gho_map}
  \end{figure}
\end{landscape}
\restoregeometry
