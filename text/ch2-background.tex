...
\subsubsection{Disease Burden and Geographical Distribution}
...
%definition (likely need another box defining treatment outcomes citing rijal2013, dahal2024)
\subsection{Definition}
In its broadest sense, VL relapse refers to the recurrence of signs and symptoms of VL following an initial treatment response\cite{chhajed2024}. Importantly, a patient may only relapse if they demonstrate an initial treatment response, also known as initial cure. In the majority of VL efficacy studies, achievement of initial cure requires not only improvement of the patient's signs and symptoms (e.g., defervescence, reduction in spleen size, weight gain, and improvement of haemoglobin), but also demonstration of parasite clearance from microscopy of a tissue aspirate. Assessment of initial cure (also known as `test of cure') most often occurs within a month of treatment completion, although considerable heterogeneity exists in exactly how and when treatment outcomes are defined\cite{dahal2024}.

\subsection{Relapse or Reinfection?}



\subsection{Burden and Timing}
...
%relevance from an individual and public health (elimination) perspective 

Mechanism

For an immunocompetent patient the immune system is expected to control the infection, conferring long-lasting protection\cite{khalil2005,zijlstra1994}

Burden.\cite{chhajed2024}

Importance from (i) individual level. (ii) Public health level.
