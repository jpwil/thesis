...
With treatment, approximately 5--15\% of cases result in death, although accurate estimates are challenged by a lack of reporting. Where deaths are reported, they frequently only reflect hospital deaths and omit those where a definite diagnosis was missed. Whilst in the 2000s, VL was blamed for causing the second highest number of deaths from a parasitic disease after malaria\cite{chappuis2007}, more recent estimates tentatively place the figure at a more modest 4,627 deaths/year with a wide uncertainty range of 1,853--8,725 deaths/year\cite{gbd2023}.
...
"To sustain the gains and achieve validation of elimination, the KAEP should continue the following minimal essential services: optimized active and passive case detection and management of KA, post-KA dermal leishmaniasis, KA-HIV coinfection and relapse supported by vector-control interventions. \cite{pandey2025}

Reviews of elimination programme in ISC \cite{sundar2018, chatterjee2025, pandey2025}
Joined by Bhutan and Thailand through the renewal of the memorandum of understanding in 2014. Deadline updated to 2017 and subsequently 2020\cite{WHO_KalaAzarElimination_2015}

And then integrated into the NTD Roadmap 2021--2030
2021--2030 NTD Roadmap\cite{WHO_NTDs_Roadmap_2021_2030} pp. 122--125
\cite{}

Bangladesh elimination declared 2023. \cite{nagi2024}
2025 update to NTD roadmap \cite{WHO_Global_Report_NTDs_2025}
Active case detection is a critical action to achieve elimination targets
WHO recognises: Time between onset of symptoms and treatment is too long (in most cases 1--3 months, and even more so for PKDL)
Critical action required: enable early detection to ensure prompt treatment

RTAG decision to integrate elimination goals with NTD 2021-2030 road map (also relapse definition) \cite{WHO_SEA_CD_329_2021}

Call to action EA elimination \cite{alvar2021}

%	You might explicitly link these epidemiologic shifts to the relevance of relapse prediction: e.g., as incidence falls, relapse (and PKDL) become proportionally more important for sustaining transmission.

\section{Relapse}

\subsection{Definition}

In its broadest sense, VL relapse refers to the reappearance of signs and symptoms of VL following an initial treatment response\cite{WHO_SEA_CD_329_2021, chhajed2024}.
...
Distinguishing between a `true relapse' caused by parasite recrudescence, and re-infection from a new strain, is important when assessing drug efficacy and evaluating related determinants of observed relapses. However, unlike in malaria\cite{WHO_2009_surveillance_antimalarial_drug_efficacy}, in VL there are no validated molecular targets for PCR confirmation. Despite this, there is mounting evidence that the majority of observed relapses occur due to recrudesence. Rijal et al. performed kDNA fingerprinting in 8 pairs of bone marrow samples in HIV-negative patients before treatment of their primary infection and at the time of relapse, and found no evidence of reinfection\cite{rijal2013}. Similar studies have been performed in VL-HIV co-infection patients in East Africa and southern Europe using a variety of molecular techniques, and showing that while reinfection does occur, it is considerably less common than recrudescence\cite{franssen2021, morales2002, gelanew2010,lachaud2009}.

\subsection{Why is relapse important?}

At the individual patient level, VL relapse can

Public health level and elimination

Xenodiagnosis studies show that patients with active VL and PKDL are infectious to sandflies. Despite being common, asymptomatic infection not considered important.\cite{singh2021, mondal2019}

Concerns re: CL as potential reservoir \cite{bhattarai2025}
India

Concerns re: de novo resistance mutations

Public health level:
- elimination: important
- prediction modelling (comparison of predictions from three prediction models)\cite{lerutte2017}
- challenges of applying modelling in ISC\cite{dial2022}
