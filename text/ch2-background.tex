...
The contents of this section are guided by a review of the literature. Search terms were constructed to identify the burden, timing, mechanisms and determinants of VL relapse. In accordance with the aims of this thesis, the review focusses on immunocompetent patients in the ISC and East Africa. See box \ref{box:lit-search1}. Further details in Appendix \ref{app:background}.
...
Distinguishing `true relapse' due to parasite recrudescence from re-infection from a new strain is important when assessing drug efficacy and evaluating relapse determinants. However, unlike in malaria\cite{WHO_2009_surveillance_antimalarial_drug_efficacy}, in VL there are no validated molecular targets for PCR confirmation. Despite this, growing evidence supports that the majority of observed relapses do indeed occur due to recrudescence. Rijal et al. performed kDNA fingerprinting in 8 pairs of bone marrow samples in HIV-negative patients before treatment of their primary infection and at the time of relapse. No evidence of reinfection was found, with 8 distinct kDNA fingerprints identified across the 16 samples that perfectly matched at the individual patient level\cite{rijal2013}. Similar studies have been performed in VL-HIV co-infection patients in East Africa and the Mediterranean region using a variety of molecular techniques, and showing that while reinfection can occur, it is considerably less common than recrudescence\cite{franssen2021, morales2002, gelanew2010,lachaud2009}.

\subsection{Why is relapse important?}

Relapse is harmful at the individual level not only from the increased morbidity and mortality linked to recurrent infection, but also due to the potentially toxic second-line regimens and prolonged hospital admissions. Both direct and indirect costs — including loss of patient income - can impose significant financial strain on households already affected by poverty.

Relapse is also important from a public health perspective. In areas of anthroponotic transmission, early diagnosis and treatment of all infections, including relapses, is a core pillar of both the East Africa and ISC elimination programmes, and supported by mathematical modelling\cite{lerutte2017, WHO_KalaAzarElimination_2015, WHO_2024_VL_easternAfrica}. Parasite strains isolated from relapse cases, however, are distinct from primary cases, and present additional challenges. For example, there is mounting evidence that relapse strains exhibit increased infectiousness, likely resulting from selection pressure during initial drug exposure\cite{rai2013,hendrickx2016, garcia-hernandez2015}. Antimony resistant strains selected for during the 1980s and 90s in Bihar have been shown to persist and remain highly infectious\cite{vanaerschot2011}. Additionally, \textit{de novo} resistance mutations can be selected for during treatment, as has been observed in vitro across a number of drug classes\cite{griensven2024}, and frequently described in routine clinical practice in immunosuppressed patients experiencing multiple relapses\cite{mohammed2020, bourgeois2010}.

\subsection{Relapse determinants}

Multiple factors contribute to the risk of VL relapse, and can be broadly classified into host factors, parasite factors, and treatment-related factors.
