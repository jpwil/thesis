...
\begin{mybox}{Key Finding}
    This is the first automatically numbered box.
\end{mybox}
...
Miltefosine, a repurposed anticancer drug, is currently the only effective oral agent for VL. Introduced as the first-line treatment option in the ISC in 2005, miltefosine played a central role in the launch of the tripartite elimination campaign\cite{sundar2002,bhattacharya2007,who_sea_elim2005}. Unfortunately, its use is limited by teratogenicity and gastrointestinal side effects. Additional concerns of increasing resistance led to its replacement in the ISC by single-dose liposomal amphotericin B (LAMB) in 2011\cite{rijal2013,sundar2012,chatterjee2025}. Outside of the ISC, miltefosine has been shown to perform poorly as monotherapy in East Africa and Brazil\cite{alves2018, carnielli2019}.

Paromomycin, an injectable aminoglycoside, has demonstrated efficacy both as monotherapy and as part of combination therapy in the ISC, with registration achieved in India in 2006\cite{sundar2007a}. Despite its relatively low cost and reassuring safety profile, paromomycin has never seen widespread use in the ISC. In contrast, in East Africa it has shown efficacy in trials of combination therapy, including with SSG, forming the current first-line treatment option\cite{WHO_TRS_949_2010, musa2012}, and with a recent trial supporting its use in combination with miltefosine\cite{musa2023}.

\begin{mybox}{Another Observation}
    This is the second automatically numbered box.
\end{mybox}

WHO L-AmB donation programme \cite{WHO2023GileadAgreement}
Combination therapy review 2024 \cite{griensven2024}
Low efficacy miltefosine in Brazil \cite{carnielli2019}
...
In patients with HIV/VL coinfection, without ART, relapse within a year of treatment is very much the norm.\cite{alvar1997, ribera1996}.

Baseline parasite load is significantly associated with relapse. The Verrest paper deserves a special mention\cite{verrest2021}. Also, in East Africa, HIV/VL coinfection, baseline parasite load is important: \cite{abongomera2017a}
