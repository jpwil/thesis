\begin{savequote}[8cm]
    \textlatin{The background chapter aims to (i) give wider context to your work, (ii) show your understandinq of your field, (iii) show the scope of your work, (iv) give any necessary definitions, (v) show the strengths and weaknesses of what has already been done and any debate
...
From population prevalence studies we know that across all endemic areas, only a minority of people with detectable parasites develop symptoms\cite{pederiva2022, burza2018}. Risk factors for acquiring an initial asymptomatic infection and subsequent progression to symptomatic disease reflect a tangled ecology of determinants linking host factors (sandfly exposure, immunity, genetics) and parasite factors (strain, virulence, inoculum). A common theme, woven indirectly into many of these determinants, is poverty.

In both the ISC and East Africa the median age of infection during stable transmission is similar at 15--20 years, and with a predilection for men, reflecting their increased occupational exposure to sandflies (for example, cattle herding and other farming activities).

In the ISC, the distribution of VL is centered in the fertile and low-lying alluvial plains of the Ganges river, where high humidity, heavy monsoon rains, and abundant vegetation provide ideal conditions for sustained transmission between sandflies and humans\cite{bhunia2010}. In particular, significant clustering of cases is seen across the rural farming communities of Bihar, Uttar Pradesh, and Jharkhand in northeastern India, West Bengal in Bangladesh, and in southeastern Nepal. In a systematic review by Bern et al., risk factors for VL transmission in the ISC were identified, and included living in mud houses, proximity to prior cases (in the same or nearby household), presence of  vegetation and standing water surrounding the house, sleeping on the floor or outside, malnutrition, and a lack of bed net use\cite{bern2010}.

The greatest concentration of cases in East Africa is currently found in the northern focus, specifically the border area between Gedaref state in eastern Sudan and the northern states of Amhara and Tigray in Ethiopia. For the purpose of elimination, the WHO is targeting nine East African countries (Chad, Djibouti, Eritrea, Ethiopia, Kenya, Somalia, South Sudan Sudan and Uganda), reflecting a wide diversity of ecological settings and region-specific risk factors\cite{WHO_2024_VL_easternAfrica,geto2024}. Many of the epidemiological determinants of VL in ISC are shared with East Africa, with poverty remaining a central overarching factor. Notable determinants include living in rural settings near sandfly breeding and resting sites (termite mounds in the southern focus, and black cotton soil, \textit{Acacia} and \textit{Balanites} trees in the northern focus), sleeping outdoors, living in proximity to other VL infected (or recently infected) people, and malnutrition.

Human immunodeficiency virus (HIV) infection has reshaped VL epidemiology in many endemic regions, and remains a major risk factor for asymptomatic infection, disease progression, and poor outcomes. For example, in the mid-1980s in Spain and other southern European countries, VL shifted from a rare childhood disease to one predominantly affecting HIV-positive adults\cite{monge2014, alvar2012}. HIV-VL co-infection rates are currently increasing in Brazil (now reported in 20\% of new cases\cite{PAHO_Leishmaniasis_2024}) and India (reported in >10\% of VL episodes in 2023 and 2024\cite{NCVBDC2025}). In the northern Ethiopia, HIV-VL coinfection presents a significant challenge to elimination, affecting between 20 and 50\% of cases with a predominance in male migrant workers\cite{diro2014}.

% host immunity is key some of this thesis' conclusions, and explaining relapse predictors
The importance of impaired host immunity as a risk factor for disease onset and poor outcomes cannot be understated, and is thought to be driving factor for a number of devastating epidemics in the ISC and East Africa. In ISC: cyclical nature of disease. In EA: epidemics associated with forced displacement of a malnourished and immune-naive populations into endemic foci, and also other way around.
