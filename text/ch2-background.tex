...
\begin{landscape}
  ...
  \begin{figure}[tb]
    \centering
    \includegraphics[clip, trim={0.25cm 2.35cm 0.2cm 2.25cm}, width=\linewidth]{figures/ch2/gho_map.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=1\textwidth]{figures/ch2/gho_plot_top8.pdf}
