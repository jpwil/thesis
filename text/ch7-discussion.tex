...
In such contexts, initial treatment failure is largely driven by early mortality due to advanced disease at presentation and severe organ dysfunction. These patients do not reach a post-treatment state in which relapse can occur, and the associated risk factors reflect determinants of survival rather than failure of parasite suppression. Extrapolating predictors of treatment failure from these settings to relapse is therefore biologically inappropriate, given the distinct underlying pathophysiology.

By contrast, in low-mortality settings without significant drug resistance, or in studies that exclude patients with severe disease, initial treatment failure is typically a rare event, and when it does occur, usually reflects a positive test-of-cure following treatment completion. In this context, treatment failure better reflects inadequate parasite suppression and thus shares mechanistic overlap with relapse. However, depending on study definitions, treatment failure may also include patients who discontinue treatment due to drug toxicity or event those who abandon therapy for non-biological reasons, further contributing to outcome heterogeneity.

On reflection, initial treatment failure is a heterogeneous construct that varies substantially across studies and settings, frequently encompassing multiple underlying processes, including death due to advanced disease, treatment discontinuation due to adverse events, and inadequate parasite suppression. The relative contribution of these components depends on the patient population, clinical setting, and study design. While treatment failure defined by parasitological non-response in low-mortality settings may serve as a partial proxy for relapse risk (inadequate parasite suppression), in high-mortality settings, or when treatment also captures discontinuation due to adverse events, extrapolating risk factors from initial treatment failure to relapse is likely misleading.

\subsubsection{Post-treatment Stage}

Expert consensus holds that VL treatment rarely results in sterile cure, as evidenced by murine models\cite{murray1996}, the persistence of serological markers following clinical cure\cite{gidwani2011}, the frequent detection of viable parasites at test-of-cure despite no subsequent relapse\cite{verrest2021}, case reports of disease reactivation many years after initial exposure\cite{eichenberger2017, postorino2011}, and the recent detection of quiescent parasites within bone marrow niches\cite{dirkx2024}. Instead, treatment is thought to suppress parasite burden to a level that allows for reconstitution of the host's cell-mediated immune response and subsequent parasite control\cite{murray1996, khalil2005}. In this context, relapse reflects a failure to achieve sustained parasite suppression, despite an initial clinical (and therefore parasitological) response. Events that occur following treatment are therefore critical in determining whether relapse occurs.

Verrest et al. (2024)\cite{verrest2024} hypothesised that post-treatment parasite dynamics are influenced by the pre-treatment parasite burden, the initial degree of parasite depletion by the treatment, the parasite virulence, and crucially, the functioning of the host's immune system. The authors constructed a semi-mechanistic model of parasite dynamics using quantitative serial PCR measurements from 172 patients recruited in three DND\textit{i} trials in East Africa. The model adequately captured parasite dynamics during and after treatment, and parasite loads measured at baseline and up to day 56 was shown to be predictive of relapse\cite{verrest2021,verrest2024}. However, despite accounting for biochemical and haematological parameters (including WBC count, haemoglobin and platelet count), the model was unable to explain the observed inter-individual variability in the timing and magnitude of post-treatment parasite recrudescence.

frequency of relapse in HIV positive, and mice models.
