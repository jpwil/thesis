...
Notably, pre-treatment parasite grade was not identified as a predictor in the multivariable models included in the literature review of relapse predictors in HIV negative patients (Section~\ref{sec:burden-relapse}, Table~\ref{tab:relapse-rf}). However, this is unsurprising, since parasite grade was not included as a candidate predictor in any of the identified studies. In contrast, spleen size was significantly associated with relapse in five of the seven identified studies where it was considered in the model\cite{sundar2019,burza2014,lucero2015,gorski2010,kajaia2011}. Given the strong association observed between spleen size and parasite grade, demonstrated both in this thesis (Appendix~\ref{app:ea-results}, Figures~\ref{fig:isc_cont_cat} and \ref{fig:ea_cont_cat}) and elsewhere\cite{kumar2018}, previously identified associations between spleen size and relapse imply that associations between parasite grade and relapse would also have been observed, if parasite grade were to have been considered in the analyses.

Indirect evidence on the link between parasite grade and relapse can be drawn from prospective studies examining the incidence of asymptomatic infection and evolution to symptomatic disease. Sudarshan et al.\ (2014) followed an Indian cohort of 511 asymptomatic individuals who were qPCR positive, of whom 10 progressed to symptomatic disease within a year. Those with higher qPCR levels were found to be at increased risk of disease progression\cite{sudarshan2014}. Similar studies show that asymptomatic individuals with higher antibody titres (DAT, rK39) are also more likely to progress to symptomatic disease\cite{hasker2014,chapman2015}, although data on the relationship between antibody titres and tissue aspirate parasite grade are lacking.

Infectious diseases beyond VL further support the plausibility of an association between pre-treatment parasite grade and relapse. In tuberculosis, higher pre-treatment bacillary loads \textemdash\ reflected by sputum smear grade, culture time-to-positivity, or baseline cavitary disease \textemdash\ are associated with delayed culture conversion and increased risk of relapse\cite{bark2012,hesseling2010}. Also, in uncomplicated malaria, higher pre-treatment parasite density is associated with increased recrudescence following artemisinin-based combination therapy\cite{white2009,WWARN2015}. Similar findings have been observed across a range of other infectious diseases, including HIV\cite{ICONA2019}, \textit{Clostridioides difficile} infection\cite{alonso2022}.

Mechanistically, pre-treatment parasite grade likely influences relapse through three interrelated pathways. Firstly, higher pre-treatment parasite grades increase the probability that residual parasites persist following treatment, thereby raising the post-treatment parasite load relative to the individual patient's putative `critical parasite load' required for immune control. Secondly, higher parasite grades are correlated with impaired host immunity. Animal models demonstrate that the degree of immunosuppression is associated with parasite density\cite{murray2002,bernardo2021}, and in humans, markedly higher parasite grades are observed in patients with VL/HIV co-infection\cite{takele2022,pareyn2025,burza2018}. Pre-treatment parasite grade both reflects and reinforces defective cell-mediated immunity, compounding relapse risk. Lastly, higher parasite grades may be associated with more virulent parasite strains, which are more likely to evade immune control and cause relapse.
