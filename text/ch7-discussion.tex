...
With this framework in mind, the mechanistic link between the identified predictors and relapse can be explained in terms of their association, whether causal or not, with (i) the post-treatment parasite load (itself determined largely by the pre-treatment parasite load and treatment regimen), (ii) host immunity, and (iii) parasite virulence.
