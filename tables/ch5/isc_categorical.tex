\begin{table}[htbp]
    ...
    \begin{threeparttable}
        \begin{tabular}{@{} l R{1.3cm} @{\hspace{4pt}} L{1.3cm} R{1.3cm} @{\hspace{4pt}} L{1.3cm} R{0.89cm} @{\hspace{4pt}} L{1.3cm} @{}}
            \toprule
            \textbf{Variable}                & \multicolumn{2}{c}{\textbf{Overall (\%)}} & \multicolumn{2}{c}{\textbf{No relapse (\%)}} & \multicolumn{2}{c}{\textbf{Relapse (\%)}}                         \\
            ...
            \hspace{1em}SDA                  & 1,331                                     & (28.9)                                       & 1,283                                     & (29.4) & 48  & (21.1) \\
            ...
            \textbf{Aspirate source}         &                                           &                                              &                                           &        &     &        \\
            \hspace{1em}Bone                 & 235                                       & (5.1)                                        & 221                                       & (5.1)  & 14  & (6.1)  \\
            \hspace{1em}Spleen               & 2,717                                     & (59.1)                                       & 2,585                                     & (59.1) & 132 & (57.9) \\
            \hspace{1em}(Missing)            & 1,647                                     & (35.8)                                       & 1,565                                     & (35.8) & 82  & (36.0) \\
            \bottomrule
        \end{tabular}
        \begin{tablenotes}
        ...
        \end{tablenotes}
    \end{threeparttable}
    \caption{Summary of categorical candidate predictors and parasite source across contributed datasets. Missing data are presented where present. Abbreviations: MF: miltefosine; SDA: Single dose liposomal amphotericin B 10mg/kg.}
