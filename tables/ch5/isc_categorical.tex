\begin{table}[htbp]
    ...
    \begin{threeparttable}
        ...
        \begin{tablenotes}
            ...
            \item[2] Single dose liposomal amphotericin B (Gilead) 10mg/kg.
        ...
        \end{tablenotes}
    \end{threeparttable}
    \caption{Summary of categorical candidate predictors and parasite source across contributed studies from the Indian subcontinent. Missing data are described where present. SDA: Single dose liposomal amphotericin B 10mg/kg.}
