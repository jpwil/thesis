\begin{table}[htbp]
    ...
    \begin{threeparttable}
        ...
        \end{tablenotes}
    \end{threeparttable}
    \caption{Summary of categorical candidate predictors and parasite source across contributed datasets. Missing data are presented where present. MF: miltefosine; SDA: Single dose liposomal amphotericin B 10mg/kg.}
