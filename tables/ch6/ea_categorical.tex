...
\begin{table}[htbp]
    ...
    \begin{threeparttable}
        ...
        \end{tablenotes}
    \end{threeparttable}
    \caption[East Africa: categorical variables]{Summary of categorical candidate predictors and parasite source across contributed studies from East Africa. Missing data are presented where present.}
